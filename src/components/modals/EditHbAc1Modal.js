// src/components/modals/EditHba1cModal.js
import React, { useState, useEffect } from 'react';
import Modal from 'react-modal';

const EditHba1cModal = ({ isOpen, onRequestClose, condition, onEditCondition }) => {
  ...
  return (
    ...
    >
      <div className="bg-white rounded-lg shadow-lg w-full max-w-md mx-4 p-6">
        <h2 className="text-xl font-bold mb-4">Edit HbA1c Condition</h2>
